...
# データは一つで十分
execute store result score $dataCount Temporary if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Skills[{Id:9999}]
...
execute store result score $ctgametime Temporary run data get storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Skills[{Id:9999}].CTGametime
...
execute if score $remainct Temporary matches 0 if score @s MP >= $reqmp Temporary run function jobpvp:skills/9999_demo/
